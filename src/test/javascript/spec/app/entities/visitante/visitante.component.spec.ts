...
import { VisitanteComponent } from 'app/entities/visitante/visitante.component';
...
describe('Component Tests', () => {
  describe('Visitante Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.visitantes && comp.visitantes[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
